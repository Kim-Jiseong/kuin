...
import lottieJson from "@/public/lottie/section1-1.json";
import LottieComponent from "@/components/common/LottieComponent";
function FirstSection() {
  return (
    <section
      className={
        "container mx-auto w-full max-w-7xl px-6 py-12 flex-grow min-h-96"
      }
    >
      <div
        className={
          "flex justify-between flex-col md:flex-row items-center gap-6"
        }
      >
        <div className="max-w-[400px] w-full flex flex-shrink-0">
        ...
        <div id="text-wrapper" className={`w-full flex flex-col gap-4`}>
          ...
          <Typography variant="text" className={`text-lg`}>
            ...
            <br />
            전문가들에게 맡기면 금방 해결될 일들이지만, 기존 외주 서비스들은
            느리고 비싸죠.
            <br />
            <br />
            &quot;쿠인&quot;은 이러한 고민 속에서 탄생했습니다. <br />
